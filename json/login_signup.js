    ...
    if(fileexits === true){
        if(checkId(login_name) === true){
            ...
            if(check_pwd === false){
                ...
                //     open_file=read_file("/home/khushigondhale/Desktop/javascript/json/DetailOfUser.json")
                //     for(i of open_file){
                //         // console.log(i)
                //         if(i["username"]=login_name){
                //             return`your name is ${i["username"]}. and your date of birth is ${i["date_of_birth"]} and your hobbies are ${i["Hobbies"]} and your gender is ${i["Gender"]} your Designation is ${i["designation"]}`
                //         }
                //     }
                // }
                // response=showDetails()
